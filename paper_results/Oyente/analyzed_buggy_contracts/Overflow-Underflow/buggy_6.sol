...
function transfer_intou14(address _to, uint _value) public returns (bool) {
    ...
    function setAddress(string  channelId, address _address) external onlyMaster onlyWhenNotStopped
    {
...
function transfer_intou30(address _to, uint _value) public returns (bool) {
    ...
    function updateChannel(string  from, string  to, address _address) external onlyMaster onlyWhenNotStopped
    {
...
function bug_intou8(uint8 p_intou8) public{
    ...
    function deleteChannel(string  channelId) external onlyMaster onlyWhenNotStopped
    {
        require(bytes(channelId).length > 0);
