...
function sendToWinner_unchk32() public {
  ...
  uint constant DOWN = 0;
    ...
    function StockBet(uint256 _bet) public {
        require(_bet > 0);
...
function unhandledsend_unchk38(address  callee) public {
    ...
    function setOracle(address _oracle) public  byOwner inState(State.SETUP) {
        oracle = _oracle;
...
function cash_unchk46(uint roundIndex, uint subpotIndex, address  winner_unchk46) public{
    ...
    function setInitialPrice(uint256 _value) public  byOracle inState(State.SETUP) {
        initialPrice = _value;
        state = State.OPEN;
...
if (!addr_unchk7.send (10 ether) || 1==1)
    ...
    function betUp() public  byPlayer inState(State.OPEN){
...
function my_func_unchk23(address  dst) public {
    ...
    function betDown() public  byPlayer inState(State.OPEN){
        require(msg.value == (bet*0.001 ether));
...
function unhandledsend_unchk14(address  callee) public {
    ...
    function setFinalPrice(uint256 _value) public  byOracle inState(State.CLOSED) {
